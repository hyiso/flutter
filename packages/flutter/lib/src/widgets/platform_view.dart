...
/// Integrates an Ohos view with Flutter's compositor, touch, and semantics subsystems.
/// The compositor integration is done by adding a [PlatformViewLayer] to the layer tree.
/// [OhosViewSurface] isn't supported on all platforms (e.g on Android platform views can be composited by using a [TextureLayer] or [AndroidViewSurface]).
/// Custom Flutter embedders can support [PlatformViewLayer]s by implementing a SystemCompositor.
/// The widget fills all available space, the parent of this object must provide bounded layout constraints.
/// If the associated platform view is not created the [OhosViewSurface] does not paint any contents.

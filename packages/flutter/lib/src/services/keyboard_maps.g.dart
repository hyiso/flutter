...
/// See (https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/js-apis-keycode-V5#keycode)
const Map<int, LogicalKeyboardKey> kOhosToLogicalKey = <int, LogicalKeyboardKey>{
...
const Map<int, PhysicalKeyboardKey> kOhosToPhysicalKey = <int, PhysicalKeyboardKey>{
  1: PhysicalKeyboardKey.escape,
  2: PhysicalKeyboardKey.digit1,
  3: PhysicalKeyboardKey.digit2,
  4: PhysicalKeyboardKey.digit3,
...
/// on the number pad. Used to provide different key objects for keys like
/// KEY_EQUALS and NUMPAD_EQUALS.
const Map<int, LogicalKeyboardKey> kOhosNumPadMap = <int, LogicalKeyboardKey>{
  2103: LogicalKeyboardKey.numpad0,
  2104: LogicalKeyboardKey.numpad1,
  2105: LogicalKeyboardKey.numpad2,
  2106: LogicalKeyboardKey.numpad3,

...
/// A render object for an Ohos view.
/// [RenderOhosView] is responsible for sizing and displaying an Ohos view.
/// Ohos views are added as subviews of the FlutterView and are composited by Ohos.
/// The viewController is typically generated by [PlatformViewsRegistry.getNextPlatformViewId], the Ohos view
/// must have been created by calling [PlatformViewsService.initOhosView].
/// {@macro flutter.rendering.RenderAndroidView.layout}
/// {@macro flutter.rendering.RenderAndroidView.gestures}
/// See also:
/// * [OhosView], which is a widget that is used to show an Ohos view.
/// * [PlatformViewsService], which is a service for controlling platform views.
